...
{ text2wfreq < language-models/pre-processed/de/wiki.txt | wfreq2vocab -records 6000000 > language-models/language-model/de/wiki.vocab; } &
{ text2wfreq < language-models/pre-processed/en/wiki.txt | wfreq2vocab -records 6000000 > language-models/language-model/en/wiki.vocab; } &
{ text2wfreq < language-models/pre-processed/en-gb/wiki.txt | wfreq2vocab -records 6000000 > language-models/language-model/en-gb/wiki.vocab; } &
{ text2wfreq < language-models/pre-processed/en-za/wiki.txt | wfreq2vocab -records 6000000 > language-models/language-model/en-za/wiki.vocab; } &
